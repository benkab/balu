...
class TransferCreate extends TrackerReact(Component) {
  ...
  addTransfer(event){
    ...
    if(!sender_firstname){
      ...
      Meteor.call('addTransfer', transfer, (error, result)=> {
        if(error){
          console.log(error);
        } else {
          Bert.alert('Un nouveau transfert a été ajouté', 'success');
        ...
        <div className="row home">
          <div className="col-sm-12">
            <p className="home-title">
              Transferts
              <a className="pull-right create-section-button" onClick={this.navigate.bind(this)}>Voir les transferts</a>
            </p>
            ...
            <div className="panel panel-default section-panel">
              ...
              <div className="panel-body">
                <form className="new-branch" onSubmit={this.addTransfer.bind(this)}>
